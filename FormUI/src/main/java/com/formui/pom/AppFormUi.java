...
import com.formui.utility.UtilityFile;


public class AppFormUi {
	...
	public void FormuiField() throws Throwable 
	{
			...
			InstFilter.sendKeys("Bajaj");
			Thread.sleep(3000);
			InstFilter.sendKeys(Keys.ENTER);
			Thread.sleep(3000);
			DocTitle.sendKeys("jai");
			Thread.sleep(3000);
			exi.executeScript("arguments[0].scrollIntoView();",uploader );
			uploader.click();
			  Thread.sleep(3000); 
			  StringSelection ss=new StringSelection("C:\\Users\\BASHA\\Desktop\\path.xlsx");
