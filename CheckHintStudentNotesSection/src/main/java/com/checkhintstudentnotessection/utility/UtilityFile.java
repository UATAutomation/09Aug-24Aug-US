package com.checkhintstudentnotessection.utility;
...
public class UtilityFile
{
	...
	public static void screenShot(WebDriver driver) 
	{
		...
		try {
			FileUtils.copyFile(src, new File("C:\\Users\\funak\\AutomationTester\\CheckHintStudentNotesSection\\SrceenShots\\"+d+".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
