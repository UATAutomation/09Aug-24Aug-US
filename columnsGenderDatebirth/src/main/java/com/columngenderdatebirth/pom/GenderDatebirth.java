...
public class GenderDatebirth {
	...
	public GenderDatebirth(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//*[@class='nav-link child-menu ng-star-inserted']//span[text()='Students']")
	WebElement student;
	...
	public void columngendr() throws Throwable {
